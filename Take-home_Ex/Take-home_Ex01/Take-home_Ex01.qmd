...
The 95% confident interval will be used. \## Clark and Evans Test
...
```{r}
#L_ck = Lest(osun_ppp, correction = "Ripley")
```
...
```{r}
#L_ck.csr <- envelope(osun_pp, Lest, nsim = 39, rank = 1, glocal=TRUE)
```
