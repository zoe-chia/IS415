...
![](images/image-1212800617.png)The Global Moran's I Test for residual spatial autocorrelation shows that it's p value is less than 0.05. Hence, we will reject the null hypothesis thta the residuals are randomly distributed.

Since the observed Moran I, 0.3984835, is greater than 0, we can infer that the residuals resemble cluster distribution.

## 6.4 Building Hedonic Pricing Models
...
![](images/image-792744810.png)

From the results, the recommended bandwidth is 341
...
![](images/image-539083858.png)

![](images/image-1872037825.png)![](images/image-2015292270.png)The adjusted R Square of GWR is **0.918** which is significantly better than the global multiple linear regression model of 0.6173.
...
![](images/image-206929719.png)From the results, **118** is the recommended data points to be used.
...
![](images/image-1110903148.png)

![](images/image-300839358.png)

![](images/image-1483060758.png)
...
Our RMSE is pretty small, given that the resale price is in the 100,000s and can go up to millions.
...
Additionally, the points are scatters around the diagonal line which shows that it is a good predictive model.

This model performed much better than the OLS Regression Model.
